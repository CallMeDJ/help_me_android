...
class RetryHandler implements HttpRequestRetryHandler {
    ...
    public boolean retryRequest(IOException exception, int executionCount, HttpContext context) {
        ...
        if(retry) {
            ...
            if (org.apache.http.NoHttpResponseException.class.equals((exception.getClass()))) {
               Log.e("loopj modification", "we have org.apache.http.NoHttpResponseException, and we do retry on POSTs");
               retry = true;
            }
        }
