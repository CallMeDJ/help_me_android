...
import com.help.activity.MyApplication;
...
public class AsyncHttpClient {
    ...
    public AsyncHttpClient() {
        ...
        DefaultHttpClient httpClientTemp = null;
        HttpContext httpContextTemp = null;
		try {
			if(!MyApplication.VerifyHttps){
				...
				httpContextTemp = new SyncBasicHttpContext(new BasicHttpContext());
				httpClientTemp = new DefaultHttpClient(cm, httpParams);
			}else{
        ...
        httpClient.addRequestInterceptor(new HttpRequestInterceptor() {
            ...
            public void process(HttpRequest request, HttpContext context) {
                ...
                // cancel
				// if (!request.containsHeader(HEADER_ACCEPT)) {
...
//            if(ESalesHttpClient.HOST_COOKIE.equals(ESalesHttpClient.currentCookie)){
//            	 if(!"".equals(ESMainActivity.getCookie())){
//                 	requestBase.setHeader("Cookie", ESMainActivity.getCookie());
//                 }
//            }else if(ESalesHttpClient.SHOP_COOKIE.equals(ESalesHttpClient.currentCookie)){
//            	if(!"".equals(ESMainActivity.getShopCookie())){
//                 	requestBase.setHeader("Cookie", ESMainActivity.getShopCookie());
//                 }
//            }else if(ESalesHttpClient.SALES_COOKIE.equals(ESalesHttpClient.currentCookie)){
//            	if(!"".equals(ESMainActivity.getSalesCookie())){
//                 	requestBase.setHeader("Cookie", ESMainActivity.getSalesCookie());
//                 }
//            }
        }
        return requestBase;
