...
public class StaticDatas {
	...
	static{
        ...
        Bitmap meinv_icon_1 = BitmapFactory.decodeResource(context.getResources(), R.drawable.meinv1);
		...
		Conversation meinv1 = new Conversation(meinv_icon_1, "怀薇","1","[微信红包]", "剩余23小时");
