...
public class ConversationListAdapter extends BaseAdapter {
	...
	public View getView(final int position, View view, ViewGroup parentView) {
		View conversation_item = LayoutInflater.from(context).inflate(
				R.layout.conversation_list_item, null);

		Conversation conversation = getItem(position);
		ImageView icon = (ImageView) conversation_item
				.findViewById(R.id.conversation_user_icon);
		TextView user_name = (TextView) conversation_item
				.findViewById(R.id.conversation_user_name);
		TextView content = (TextView) conversation_item
				.findViewById(R.id.conversation_content);
		TextView time = (TextView) conversation_item
